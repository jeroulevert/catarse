...
class Backer < ActiveRecord::Base
  ...
  validates_numericality_of :value, :greater_than_or_equal_to => 2.00
  ...
  def display_value
    number_to_currency value, :precision => 0, :currency => 'EUR'
  end
  ...
  def display_platform_fee(fee=7.5)
    number_to_currency platform_fee(fee), :precision => 2, :currency => 'EUR'
  end
